 ...
 *
 * @param {string} source - A selector string to search for source element.
 * @param {string} target - A selector string to search for target element.
...
module.exports.screenshot = async (selector, options = {}) => {
  ...
  options = { ...userOptions, ...options };
  options.path = path.normalize(options.path || `Screenshot-${Date.now()}.png`);
